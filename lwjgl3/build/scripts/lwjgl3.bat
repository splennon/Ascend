...
set CLASSPATH=%APP_HOME%\lib\Ascension-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" com.overworld.ascension.lwjgl3.Lwjgl3Launcher %*
